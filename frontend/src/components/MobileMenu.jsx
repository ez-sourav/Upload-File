...
export default function MobileMenu({ open, onClose }) {
  ...
  const menuItems = [
    { name: "All Files", icon: Files, badge: null },
    { name: "Images", icon: FileImage, badge: "12" },
    { name: "Documents", icon: FileText, badge: "8" },
    { name: "Upload Files", icon: Upload, badge: null, highlight: true },
  ];
  ...
  const handleItemClick = (itemName) => {
    ...
    setTimeout(() => onClose(), 300); // Close menu after selection
  };
