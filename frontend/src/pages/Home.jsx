  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-blue-50/30 to-indigo-50/30">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 pt-20 md:pt-24 py-6 md:py-8 space-y-6 md:space-y-8">
        {/* 🔓 PREVIEW MODE BANNER */}
        {!user && (
          <div className="bg-linear-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-2xl shadow-lg p-4 flex items-start gap-3 animate-in">
        ...
        {/* ================= STATS ================= */}
        {showStats && (
          <section className="bg-linear-to-br from-white/80 to-blue-50/50 backdrop-blur-sm rounded-3xl shadow-md border border-white/20 p-6 md:p-8">
            {!isDesktop && (
              <button
        ...
        <div id="upload-section">
          {user ? (
            ...
            <div className="bg-linear-to-br from-white to-orange-50/30 border-2 border-dashed border-orange-200 rounded-3xl shadow-lg p-6 md:p-8">
              <div className="flex flex-col items-center text-center">
                <div className="p-4 bg-orange-100 rounded-2xl mb-4">
                  <UploadIcon className="h-8 w-8 text-orange-600" />
                </div>
                ...
                <a
                  href="/login"
                  className="px-6 py-2.5 bg-linear-to-r from-blue-600 to-indigo-500 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 active:scale-[0.98] transition-all text-sm"
                >
                  Login to Upload
                </a>
              </div>
        ...
        {(!showStats || isDesktop) && (
          <section>
  <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-4 md:p-6 space-y-4 md:space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        {files.length > 0 && (
          <button
            ...
            className="sm:hidden p-2 rounded-xl hover:bg-gray-100 active:scale-95 transition-all"
          >
            {showMobileSearch ? (
      ...
      {files.length > 0 && (
        ...
        >
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all bg-white shadow-sm"
        ...
        {visibleCount < filteredFiles.length && (
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold
              ...
              border border-blue-200 rounded-xl shadow-lg hover:shadow-xl
        ...
        {isExpanded && (
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold
              ...
              border border-gray-300 rounded-xl shadow-lg hover:shadow-xl
